...
import { User, BarChart2, Settings, CheckCircle, Loader2, AlertCircle, Leaf } from 'lucide-react';
...
export function DashboardSection() {
  ...
  const { data: preferences, isLoading: prefsLoading, isError: prefsError } = useGetUserPreferences();
  ...
  useEffect(() => {
    if (preferences) {
      setDisplayName(preferences.displayName === 'Anonymous' ? '' : preferences.displayName);
  ...
  const userName = preferences?.displayName && preferences.displayName !== 'Anonymous'
    ? preferences.displayName
    : 'there';

  const visitCountDisplay = visitCount !== undefined ? Number(visitCount) : null;

  return (
    <section id="dashboard" className="py-16 md:py-20 bg-muted/30">
      <div className="container px-4 mx-auto max-w-5xl">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">Your personalized Terra Vedant Tech dashboard</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="border border-border/60 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Your engagement with our platform</CardDescription>
            </CardHeader>
            <CardContent>
              {visitLoading ? (
              ...
              <p className="text-xs text-muted-foreground mt-2">Total sessions recorded on-chain</p>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border/60 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Saved preferences for your account</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              {prefsLoading ? (
                ...
                <>
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1">Preferred Topic</p>
          ...
          <Card className="border border-border/60 shadow-sm md:col-span-1">
            ...
            <CardContent>
              {prefsLoading ? (
                ...
                <form
                  onSubmit={(e) => { e.preventDefault(); handleSavePreferences(); }}
                  className="space-y-3"
                >
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="contactTopic" className="text-xs font-medium">Preferred Contact Topic</Label>
                    <Select
