...
export class Backend implements backendInterface {
    ...
    async getPersonalizedDashboard(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalizedDashboard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPreferences(): Promise<UserProfile> {
        if (this.processError) {
            try {
    ...
    async updateUserPreferences(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserPreferences(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
